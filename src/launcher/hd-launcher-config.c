...
#define HD_LAUNCHER_CONFIG_GET_PRIVATE(obj) (G_TYPE_INSTANCE_GET_PRIVATE ((obj), \
                                HD_TYPE_LAUNCHER_CONFIG, HdLauncherConfigPrivate))
...
hd_launcher_config_init (HdLauncherConfig *self)
{
  ...
  priv->tile_font = g_strdup (HD_LAUNCHER_TILE_DEFAULT_FONT);
                            	...
                            	GObjectConstructParam *properties)
{
  ...
  obj = 
    G_OBJECT_CLASS(hd_launcher_config_parent_class)->constructor (gtype,
								  n_properties,
								  properties);
  priv = 
    HD_LAUNCHER_CONFIG_GET_PRIVATE (HD_LAUNCHER_CONFIG (obj));
